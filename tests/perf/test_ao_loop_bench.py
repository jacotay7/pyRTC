    ...
    report = {
        ...
        "results": {
            "pywfs": {
                ...
                "20x20": {
                    "cpu": {"p99_hz": 800.0, "p99_s": 0.00125},
                    "gpu": {"p99_hz": 1600.0, "p99_s": 0.000625},
                },
                "60x60": {
                    "cpu": {"p99_hz": 100.0, "p99_s": 0.01},
                    "gpu": {"p99_hz": 400.0, "p99_s": 0.0025},
                },
            },
            "shwfs": {
                "10x10": {
                    "cpu": {"p99_hz": 1200.0, "p99_s": 0.000833},
                    "gpu": {"p99_hz": 1800.0, "p99_s": 0.000556},
                },
                "20x20": {
                    "cpu": {"p99_hz": 900.0, "p99_s": 0.001111},
                    "gpu": {"p99_hz": 1400.0, "p99_s": 0.000714},
                },
                "60x60": {
                    "cpu": {"p99_hz": 120.0, "p99_s": 0.008333},
                    "gpu": {"p99_hz": 450.0, "p99_s": 0.002222},
                },
            },
        },
    }
